...
urlpatterns = [
    ...
    url(r'^(?P<contest_id>[0-9]+)/$', views.contest_views.contest_details, name='contest_details'),
    ...
    url(r'^(?P<contest_id>[0-9]+)/verify/$', views.contest_views.verify_contest, name="verify_contest"),
